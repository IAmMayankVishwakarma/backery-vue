        ...
        <div class="container image-section-inside">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <span class="comic-text wow fadeIn" data-wow-delay="0.5s">Reserve</span>
                    
                    <h2 class="section-title white wow bounceIn" data-wow-delay="1s">Your Table</h2>
                    
                    <p class="hero-text wow fadeInUp" data-wow-delay="2s">An unforgettable night experience in the heart of Covent Garden, London.<br>Contemporary british pub, inspired by the traditions of Great Britain.</p>
                ...
                <ul>	
                    ...
                    <li data-index="rs-333" data-transition="fade" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"  data-rotate="0"  data-saveperformance="off"  data-title="Intro" data-description="">
                        ...
                        <div class="rs-background-video-layer" 
                            ...
                            data-videomp4="videos/restaurant1.mp4" 
                        ...
                        <div class="tp-caption RotatingWords-TitleWhite   tp-resizeme  toblur rs-parallaxlevel-0" 
                            ...
                            style="z-index: 6; white-space: nowrap;">WE LOVE <span style="color:#E67E22;">OUR CLIENTS</span>
                        </div>
                        ...
                        <div class="tp-caption RotatingWords-Button rev-btn  rs-parallaxlevel-0" 
                            ...
                            style="z-index: 11; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Discover History
                        </div>
