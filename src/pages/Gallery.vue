                ...
                <div class="col-md-4 margin-bottom-30">
                    ...
                    <div class="popup-wrapper">
                        <div class="popup-gallery">
                            <a class="popup3" href="http://placehold.it/800x600"><img src="http://placehold.it/800x600" class="width-100" alt="pic"><span class="eye-wrapper"><i class="pe-7s-expand1 eye-icon"></i></span></a>
                        </div>
                    </div>
                    <!--begin popup image -->
